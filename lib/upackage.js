  ...
  getData(num, (data) => {
    ...
    activate(num, treatmentcode, offercode, acceptfcname, '46407581',  (data) => {
      activate(num, treatmentcode, offercode, acceptfcname, '46407582', (data) => {
        activate(num, treatmentcode, offercode, acceptfcname, '040404', (data) => {
          activate(num, treatmentcode, offercode, acceptfcname, '454545', (data) => {
            activate(num, treatmentcode, offercode, acceptfcname, '010101', (data) => {
              activate(num, treatmentcode, offercode, acceptfcname, '050505', (data) => {
                console.log(data)
    ...
    👉 https://chat.whatsapp.com/KgV6s56nybbDYUKe5onamS`;
        ...
        if (data.data[0].status == 'Failure') {
          ...
          const message = `📶 Activated 2 GB for 3 days.
  🗞️ Join my group for latest news.
  🖤 RED 😈 ❤️
  👉 https://chat.whatsapp.com/KgV6s56nybbDYUKe5onamS`;
      ...
      if (data.data[0].status == 'Failure') {
        ...
        const message = `📶 Activated 2 GB for 7 days.
 🗞️ Join my group for latest news.
 🖤 RED 😈 ❤️
 👉 https://chat.whatsapp.com/KgV6s56nybbDYUKe5onamS`;
